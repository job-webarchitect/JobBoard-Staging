...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/common/css/owl.theme.css" media="screen">
...
<!-- ./ Search Content -->
<!--<p ng-repeat="pos in positions | filter:position">{{pos.position}}</p>-->
  <div class="row">
...
function logoCarousel_Lg(){
  $('.logo-carousel .item').each(function(){
  var next = $(this).next();
  if (!next.length) {
...
$(document).ready(function() {
  var owl = $("#owl-demo");
    ...
    $("#owl-demo1").owlCarousel({
      autoPlay :true,
      slideSpeed : 400,
      jsonPath : '<?php echo base_url();?>assets/json/customData.json',
      jsonSuccess : customDataSuccess
  });
 
  function customDataSuccess(data){
    var content = "";
    for(var i in data["items1"]){    
       var img = data["items1"][i].img;
       var alt = data["items1"][i].alt;
       content += "<img src=\"<?php echo base_url();?>assets/common/" +img+ "\" alt=\"" +alt+ "\" height='auto' width='180'>"
    }
    $("#owl-demo1").html(content);
  }
});
</script>
</body>
