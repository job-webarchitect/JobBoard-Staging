...
class Mandrill
{
    ...
    function __construct()
    {
        ...
        $this->init($this->ci->config->item('mandrill_api_key'));
    }
    function init($api)
    {
        if (empty($api))
        ...
        try {
            $response = $this->request('users/ping2', array(
                'key' => $api
            ));
    ...
    */
    ...
    {
        return $this->request('users/disable-senders', array(
            'domain' => $domain
        ));
    }
    /*
    ...
    */
    ...
    {
        return $this->request('users/verify-senders', array(
            'domain' => $email
        ));
    }
    /*
    ...
    */
    ...
    {
        return $this->request('senders/info', array(
            'address' => $email
        ));
    }
    /*
    ...
    */
    ...
    {
        return $this->request('senders/time-series', array(
            'address' => $email
        ));
    }
    /*
    ...
    */
    ...
    {
        return $this->request('tags/info', array(
            'tag' => $tag
        ));
    }
    /*
    ...
    */
    ...
    {
        return $this->request('tags/time-series', array(
            'tag' => $tag
        ));
    }
    /*
    ...
    */
    ...
    {
        return $this->request('templates/delete', array(
            'name' => $name
        ));
    }
    /*
    ...
    */
    ...
    {
        return $this->request('templates/info', array(
            'name' => $name
        ));
    }
    /*
    ...
    */
    ...
    {
        return $this->request('templates/time-series', array(
            'name' => $name
        ));
    }
    ...
    */
    ...
    {
        return $this->request('urls/time-series', array(
            'name' => $name
        ));
    }
    ...
    */
    ...
    {
        return $this->request('urls/search', array(
            'q' => $q
        ));
    }
    ...
    */
    ...
    {
        return $this->request('webhooks/delete', array(
            'id' => $id
        ));
    }
    ...
    */
    ...
    {
        return $this->request('webhooks/info', array(
            'id' => $id
        ));
    }
