...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <?php if($permission =='5') : ?>
       	  <li class="active"><a href="<?php echo site_url('admin/consultancy') ?>"><i class=""></i><span>manage Consultant</span> </a> </li>
       	  <li><a href="<?php echo site_url('admin/consultantlist') ?>"><i class=""></i><span>All Request List</span> </a> </li>  
         <?php endif; ?>
                                    ...
                                    <tbody>
                                          ...
                                          <?php
										    ...
										    if($status == 1) :   ?>
                                             ...
                                             <td><a class="btn-success btn" href="<?php echo site_url('admin/consdetails/' . $row->company_id) ?>">
