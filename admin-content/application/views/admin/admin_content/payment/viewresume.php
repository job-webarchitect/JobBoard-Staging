    ...
    <div class="container">
      <ul class="mainnav">
        <li><a href="<?php echo site_url('admin/paymentplan')?>"><i class=""></i><span>Resume Download</span> </a> </li> 
         <li class="active"><a href="<?php echo site_url('admin/viewresume')?>"><i class=""></i><span>View Resume</span> </a> </li> 
...
<div class="main main-minhight">
  <div class="main-inner">
    <div class="container">
      <div class="row">
      <?php $rmsg = $this->session->flashdata('resumeview');
	  		$umsg = $this->session->flashdata('updateview');
	  		$dmsg = $this->session->flashdata('deleteview');
              ...
              <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($permission !='0') : ?>  
                                          		 <td><a class="btn-danger btn" href="<?php echo site_url('admin/editviewresume/'.$row->planid)?>">
            											<span class="glyphicon glyphicon-log-in"></span>Edit</a> 
                                                     <a class="btn-danger btn" href="<?php echo site_url('admin/removeviewresume/'.$row->planid)?>">
