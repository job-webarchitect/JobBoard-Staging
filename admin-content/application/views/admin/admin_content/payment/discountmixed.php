...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li><a href="<?php echo site_url('admin/discountplan')?>"><i class=""></i><span>Resume Download</span> </a> </li> 
         <li><a href="<?php echo site_url('admin/discountviewresume')?>"><i class=""></i><span>View Resume</span> </a> </li> 
         <li><a href="<?php echo site_url('admin/discountemail')?>"><i></i><span>Email Service</span> </a> </li> 
         <li class="active"><a href="<?php echo site_url('admin/discountmixed')?>"><i></i><span>Mixed Plan</span> </a> </li>      
  ...
  <div class="main-inner">
    <div class="container">
      ...
      <?php $rmsg = $this->session->flashdata('resumemessage');
	  		$umsg = $this->session->flashdata('updatediscountmixed');
	  		$dmsg = $this->session->flashdata('removediscountmixed');
                                    ...
                                    <tbody>
                                       <?php foreach($discountplan as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row->used_email ?></td>
                                            <td><?php echo $row->original_cost?></td> 
                                             <td><?php echo $row->discount_cost ?></td>
                                             <td><?php echo $row->validity ?></td> 
                                           <?php if($permission !='0') : ?>
                                           <td><a class="btn-danger btn" href="<?php echo site_url('admin/editdiscountmixed/'.$row->discount_id)?>">
            <span class="glyphicon glyphicon-log-in"></span>Edit</a> <a class="btn-danger btn" href="<?php echo site_url('admin/removediscountmixed/'.$row->discount_id)?>">
