<?php $page = $this->uri->segment(2);var_dump()?>
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li <?php if($page=="addtranslator") { echo 'class="active"'; } ?>><a href="<?php echo site_url('admin/translator/addtranslator')?>"><i class=""></i><span>Add Translator</span> </a> </li>    
        <li <?php if($page=="assign") { echo 'class="active"'; } ?>><a href="<?php echo site_url('admin/translator/assign')?>"><i class=""></i><span>Assign Job Translator</span> </a> </li>  
