        ...
        <div class="main-width">
          <div class="widget">
            ...
            <div class="span12">
              ...
              <div class="span4"><input type="text" placeholder="Enter Company Name" id="cname" name="cname"></div>
               <div style="color: red;"><?php echo form_error('cname'); ?></div>
              </div>
              ...
              <div class="span4"><input type="text" placeholder="Enter Discount Price" id="dprice" name="dprice" ></div>
               <div style="color: red;"><?php echo form_error('dprice'); ?></div>
              </div>
            ...
            <span class="glyphicon glyphicon-log-in "></span><?php echo form_submit(array('id' => 'submit', 'value' => 'Submit')); ?></div>
            <?php echo form_close(); ?> 
            </div>
            <!-- /widget-content --> 
          </div>
