  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li  class="active"><a href="<?php echo site_url('admin/discountemail')?>"><i></i><span>Discount Email Service</span> </a> </li> 
...
<div class="main main-minhight">
  <div class="main-inner">
    <div class="container">
      <div class="row">
      <?php $rmsg = $this->session->flashdata('updatediscountemail');
	  		$umsg = $this->session->flashdata('updatemessage');
	  		$dmsg = $this->session->flashdata('removediscountemail');
        ...
        <div class="main-width">
          <div class="widget widget-table action-table">
            <div class="widget-header">
              <h3>Discount Email Service</h3>
            </div>
            
            <!-- /widget-header -->
            <div class="widget-content">
                <?php if(!empty($discountemail)) : ?>
              <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>Company Name</th>
                                            <th>No. of Email Service</th>
                                    ...
                                    <tbody>
                                        <?php foreach($discountemail as $row) : ?>
                                        <tr>
                                            ...
                                            <?php if($permission !='0') : ?>
                                           <td><a class="btn-danger btn" href="<?php echo site_url('admin/editdiscountemail/'.$row->discount_id)?>">
            <span class="glyphicon glyphicon-log-in"></span>Edit</a> <a class="btn-danger btn" href="<?php echo site_url('admin/removediscountemail/'.$row->discount_id)?>">
