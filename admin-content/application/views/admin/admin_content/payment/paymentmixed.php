    ...
    <div class="container">
      <ul class="mainnav">
        <li><a href="<?php echo site_url('admin/paymentplan')?>"><i class=""></i><span>Resume Download</span> </a> </li> 
         ...
         <li class="active"><a href="<?php echo site_url('admin/paymentmixed')?>"><i></i><span>Mixed Plan</span> </a> </li> 
  ...
  <div class="main-inner">
    <div class="container">
      ...
      <?php $rmsg = $this->session->flashdata('resumemessage');
	  		$umsg = $this->session->flashdata('updatemixedplan');
	  		$dmsg = $this->session->flashdata('removemixedplan');
              ...
              <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($permission !='0') : ?>  
                                           		<td><a class="btn-danger btn" href="<?php echo site_url('admin/editmixedplan/'.$row->planid)?>">
											            <span class="glyphicon glyphicon-log-in"></span>Edit</a> 
                                                    <a class="btn-danger btn" href="<?php echo site_url('admin/removemixedplan/'.$row->planid)?>">
