  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
         ...
         <li class="active"><a href="<?php echo site_url('admin/paymentemail')?>"><i></i><span>Email Service</span> </a> </li> 
...
<div class="main main-minhight">
  <div class="main-inner">
    <div class="container">
      <div class="row">
      <?php $rmsg = $this->session->flashdata('emailmessage');
	  		$umsg = $this->session->flashdata('updateemailmessage');
	  		$dmsg = $this->session->flashdata('deleteemailmessage');
            ...
            <div class="widget-content">
             <?php if(!empty($emailservice)) : ?>
              <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                         <?php foreach($emailservice as $row) : ?>
                                        <tr>
                                            ...
                                            <?php if($permission !='0') : ?>  
                                           <td>
                                           		<a class="btn-danger btn" href="<?php echo site_url('admin/editemailservice/'.$row->planid)?>">
            											<span class="glyphicon glyphicon-log-in"></span>Edit</a>
                                                 <a class="btn-danger btn" href="<?php echo site_url('admin/removeemailservice/'.$row->planid)?>">
