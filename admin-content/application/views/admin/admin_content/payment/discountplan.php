...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="<?php echo site_url('admin/discountplan')?>"><i class=""></i><span>Discount Resume Download</span> </a> </li>
...
<div class="main main-minhight">
  <div class="main-inner">
    <div class="container">
      <div class="row">
      <?php $rmsg = $this->session->flashdata('updatediscountdownload');
	  		$msg = $this->session->flashdata('resumemessage');
	  		$dmsg = $this->session->flashdata('removediscountdownload');
        ...
        <div class="main-width">
          <div class="widget widget-table action-table">
            <div class="widget-header">
              <h3>Discount Resume Download</h3>
            </div>
              ...
              <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php foreach($discountplan as $row) : ?>
                                        <tr>
                                           ...
                                           <?php if($permission !='0') : ?>
                                           <td><a class="btn-danger btn" href="<?php echo site_url('admin/editdiscountdownload/'.$row->discount_id)?>">
            <span class="glyphicon glyphicon-log-in"></span>Edit</a> <a class="btn-danger btn" href="<?php echo site_url('admin/removediscountdownload/'.$row->discount_id)?>">
