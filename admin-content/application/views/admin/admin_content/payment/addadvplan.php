                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="span12">
                                ...
                                <div class="span4"><input type="text" placeholder="Enter the Headline" id="advname" name="advname" ></div>
                                <div style="color: red;"><?php echo form_error('advname'); ?></div>
                            </div>

                            <div class="span12">
                                <div class="span2">Price :</div>
                                <div class="span4"><input type="text" placeholder="Enter the Price" id="advprice" name="advprice" ></div>
