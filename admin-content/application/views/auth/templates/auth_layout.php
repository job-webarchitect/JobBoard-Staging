...
<body>
  ...
  <div class="navbar-inner">
    ...
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    ...
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand brand-padding" href="index.php"><img width="200px" src="<?php echo base_url();?>assets/img/logo.png"/></a>  
